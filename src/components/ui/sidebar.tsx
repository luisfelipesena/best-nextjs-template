  ...
  return (
    <div
      ...
      className={cn(
        ...
        'border-r-border/40 relative h-svh w-[--sidebar-width] border-r',
        'data-[state=closed]:w-[--sidebar-width-icon]',
...
const SidebarMenuAction = React.forwardRef<React.ElementRef<typeof Button>, React.ComponentProps<typeof Button>>(
  ({ className, ...props }, ref) => {
    return (
      <Button
        ref={ref}
